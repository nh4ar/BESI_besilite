...
public class GetEmotions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_emotions);

        sharedPref = PreferenceManager.getDefaultSharedPreferences(this);

        final TextView mTextView = (TextView) findViewById(R.id.textView2);
        final ListView mListView = (ListView) findViewById(R.id.emotionListView);
...
//      Create our adapter to add items
        ...
        String endpoint ="api/v1/survey/fields/e/?format=json";
